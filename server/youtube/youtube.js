...
exports.getYouTubeAudio = function(videoId){
    ...
    youtube_dl = spawn('youtube-dl', ['--extract-audio', '--audio-format', 'mp3', '-o', (__base + '../temp/' + videoId + '.%(ext)s'), "http://www.youtube.com/watch?v=" + videoId]);
    ...
    youtube_dl.on('exit', function(){
      var mp3File = path.join(__base, '../temp/', videoId + '.mp3');
